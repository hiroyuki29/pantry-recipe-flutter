...
abstract class PantryRepository {
  ...
  Future<void> incrementPantryItemQuantity(
      String pantryItemId, int unitQuantity);
}
...
class PantryRepositoryImpl implements PantryRepository {
  ...
  Future<void> moveFromMemo(Map<String, dynamic> bodyInputMap) async {
    NetworkHelper networkHelper = NetworkHelper();
    await networkHelper.postData(
        urlInput: 'pantries/move_from_memo',
        headerInput: _userHeader,
        bodyInput: jsonEncode(bodyInputMap));
  }
  ...
  @override
  Future<void> incrementPantryItemQuantity(
      String pantryItemId, int unitQuantity) async {
    final prefs = await SharedPreferences.getInstance();
    NetworkHelper networkHelper = NetworkHelper();
    ...
    await networkHelper.putData(
        urlInput: 'pantries/$pantryItemId/increment',
        headerInput: _userHeader,
